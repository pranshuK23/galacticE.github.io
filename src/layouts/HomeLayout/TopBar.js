      ...
      <Container maxWidth="lg" className="p-0">
        <Toolbar className={toolbar}>
          ...
          >
            ...
            &nbsp; &nbsp; &nbsp; &nbsp;
            <Link className={icn}>
              <TwitterIcon style={{ color: "black", padding:"3px" }} />
            </Link>
            &nbsp; &nbsp;
            {/* </Box> */}
            {/* <Box className={icn}> */}
            <Link className={icn}>
              <InstagramIcon style={{ color: "black", padding:"3px"}} />
            </Link>
            &nbsp; &nbsp; &nbsp; &nbsp;
            {/* <Box/> */}
  ...
  return (
    <>
      <AppBar
        ...
        elevation={0}
        style={{ backgroundColor: "black", border: "none", position: "fixed" }}
      >
        <Container
